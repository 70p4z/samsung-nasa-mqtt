...
def mqtt_setup():
  ...
  mqtt_create_topic(0x4427, 'homeassistant/sensor/samsung_ehs_total_power/config', 'energy', 'Samsung EHS Total Output Power', 'homeassistant/sensor/samsung_ehs_total_power/state', 'Wh', MQTTHandler, None)
